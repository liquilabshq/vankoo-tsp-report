...
|---------|------------|---------------------------------|--------------------------------------------------------------------------|
| 1.0.0   | 2026-09-06 | Ramirez Mestanza, Salim Ignacio | Creación de la estructura base del informe, carátula y registro de versiones. |
|         |            |                                 |                                                                          |
...
|:--------------------|:--------------------|:-------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Amaro Villar, Anjali**<br>**TB1**<br>_Pendiente de elaboración._<br><br>**Crispin Ramos, Daniel Franco**<br>**TB1**<br>_Pendiente de elaboración._<br><br>**Ramirez Mestanza, Salim Ignacio**<br>**TB1**<br>_Pendiente de elaboración._<br><br>**Sulca Gonzales, Paúl Fernando**<br>**TB1**<br>_Pendiente de elaboración._<br><br>**Vilca Saboya, Diego Alejandro**<br>**TB1**<br>_Pendiente de elaboración._ | **TB1**<br>_Pendiente de elaboración._ |
...
<!-- Enunciado del problema y descripción de los puntos más importantes que debe resolver la solución propuesta, junto con objetivos y restricciones que delimiten el alcance del proyecto. Aplicar previamente la técnica de The 5 'W's y 2 'H's. -->
...
<!-- Aplicación del Lean UX Process sobre el dominio del problema, abarcando la visión del modelo de negocio que será soportado por el producto de software. -->
...
<!-- Formato: Creemos que [resultado]. Sabremos que hemos tenido éxito cuando [señal medible]. -->
...
<!-- Proceso de Needfinding junto con el análisis de la competencia. Las entrevistas se registran en video y se editan para construir el video de evidencia de entrevistas. -->

_Pendiente de elaboración: párrafo introductorio del capítulo._

## 2.1. Competidores

<!-- Identificar y describir mínimo 3 competidores directos con modelos de negocio basados en productos digitales similares, o en su defecto competidores indirectos con ofertas parcialmente similares. -->
...
<!-- Competitive Analysis Landscape según el formato del enunciado. En la cabecera colocar por cada competidor su nombre y logo. -->
...
| | | **LiquiLabs (Vankoo)** | **Competidor 1** | **Competidor 2** | **Competidor 3** |
| **Perfil** | Overview | | | | |
...
<!-- Un solo cuadro para todo el conjunto de Epics y User Stories, una línea por cada uno. Los criterios de aceptación se redactan en tiempo presente, tercera persona, sin referencias a la interfaz de usuario, comprobables y bajo la estructura Gherkin (Given-When-Then).
Incluir además:
- User Stories del sitio web estático (Landing Page), con rol base "visitante".
- Technical Stories para los features del RESTful API, con rol "Developer" y como criterios de aceptación los escenarios de request/response. -->
...
|---|---|---|---|---|
| EP01 |  |  |  |  |
| US01 |  | Como… deseo… para… | **Escenario 1:** Given… When… Then… |  |
| TS01 |  | Como Developer… deseo… para… | **Escenario 1:** Given… When… Then… |  |
...
<!-- Estimación y priorización de los User Stories. El orden lo determina el valor para el negocio (colocar al inicio los User Stories de seguridad o autenticación se considera incorrecto). Los User Stories del Landing Page se consideran desde el primer sprint. Incluir captura y URL del enlace público del product backlog en la herramienta indicada. -->
<!-- Assets: ./assets/cap3-requirements-specification/product-backlog/ -->

_Pendiente de elaboración._

Enlace público del Product Backlog: _Pendiente de elaboración._
